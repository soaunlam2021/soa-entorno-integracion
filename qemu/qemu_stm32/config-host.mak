...
libs_softmmu=-lutil  -luuid -L/usr/lib/x86_64-linux-gnu -lpng16 -lz  -L/usr/lib/x86_64-linux-gnu -lSDL  -lX11  -lfdt -L/usr/lib/x86_64-linux-gnu -lpixman-1 
ARCH=x86_64
CONFIG_DEBUG_TCG=y
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.1.3
PKGVERSION=
SRC_PATH=/soa-entorno-integracion/qemu/qemu_stm32
...
CFLAGS_NOPIE=
QEMU_CFLAGS=-fPIE -DPIE -m64 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing -fno-common -w  -Wendif-labels -Wmissing-include-dirs -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -fstack-protector-strong -I/usr/include/libpng16  -I/usr/include/pixman-1  
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/soa-entorno-integracion/qemu/qemu_stm32/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g 
LDFLAGS_NOPIE=
LIBTOOLFLAGS= -Wc,-fstack-protector-strong
LIBS+=-lm -L/usr/lib/x86_64-linux-gnu -lgthread-2.0 -pthread -lglib-2.0   -lz -lrt
LIBS_TOOLS+=-luuid 
EXESUF=
DSOSUF=.so
LDFLAGS_SHARED=-shared
LIBS_QGA+=-lm -L/usr/lib/x86_64-linux-gnu -lgthread-2.0 -pthread -lglib-2.0   -lrt
